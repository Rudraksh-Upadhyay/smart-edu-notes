...
function AskAIButton( {user } : Props) {
    ...
    const handleSubmit = () => {
        ...
        startTransition(async () => {
            const response = await AskAIAboutNotesActiono(newQuestions, responses);
    ...
    return (
        ...
        <DialogContent className="custum-scrollbar flex h-[85vh] max-w-4xl flex-col overflow-y-auto">
            <DialogHeader>
                <DialogTitle>Ask AI about your Notes</DialogTitle>
                <DialogDescription>
                    AI can answer questions about your notes.
                </DialogDescription>
            </DialogHeader>
